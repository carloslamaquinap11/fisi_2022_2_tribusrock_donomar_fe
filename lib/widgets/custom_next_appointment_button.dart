    ...
    return ElevatedButton(
      ...
      child: Column(
        ...
        children: [
          ...
          Flexible(
            child: Container(
              child: Text(name!,style: TextStyle(fontSize: 15,fontWeight: FontWeight.w700,color: Color(0xFF57C2FE)),maxLines: 2,softWrap: false,overflow: TextOverflow.ellipsis,),
            ),
          ),
          SizedBox(height: 5,),
          Row(
            children: [
              Icon(Icons.alarm_add_outlined,color: Color(0xFF57C2FE),),
